...
/// Util for parsing dmc official web data (same object format from realtimeDB)
class DmcParserUtil {
  DmcEntityData getDmcEntityDatafromDmcJson(Map<Object?, Object?> objectMap) {
    // Convert drawDate to DateTime obj
    final drawDate = objectMap['drawDate'].toDateTimeFromddMMyyyy();
